...
このプラグインは、WordPress 管理画面とウェブページに Google Gemini API（gemini-3-flash-preview）ベースのチャットボットを追加するものです。管理画面でアップロードしたファイル（PDFや画像など）を Gemini File Search に保存し、その内容や手動 FAQ を参照しながら自然言語の質問に回答します。
...
* WordPress 6.0 以上
* PHP 7.4 以上
* Google Cloud アカウントと Gemini API キー（gemini-3-flash-preview へのアクセス権）
